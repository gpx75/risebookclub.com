        ...
        <Container>
            ...
            <ul role="list" class="mt-12 flex flex-wrap items-center justify-center gap-4 py-4 text-gray-600 dark:text-gray-400 sm:gap-8">
                <li role="listitem" v-for="link in links" :key="link.link">
                    <nuxt-link :to="link.to" class="duration-300 hover:text-primary dark:hover:text-white">
                        {{ link.label }}
                    </nuxt-link>
                </li>
            </ul>
            <div class="m-auto mt-4 flex w-max items-center justify-between space-x-4 text-gray-500">
                <a class="duration-300 hover:text-gray-600 dark:hover:text-white" href="#" title="twitter" target="blank" aria-label="twitter">
                ...
                <a class="duration-300 hover:text-gray-600 dark:hover:text-white" href="#" title="facebook" target="blank" aria-label="facebook">
                ...
                <a class="duration-300 hover:text-gray-600 dark:hover:text-white" href="#" title="linkedin" target="blank" aria-label="linkedin">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="m-auto w-5" viewBox="0 0 16 16">
