    ...
    <section class="relative pt-32 md:pt-44" id="about">
        <Container>
            <div class="mx-auto md:w-3/5">
                <h2 class="text-center text-3xl font-bold text-gray-900 dark:text-white md:text-4xl lg:text-5xl">Your Medium for Transformation.</h2>
                <p class="mt-4 text-center text-gray-600 dark:text-gray-300">We read non-fiction books, with an interest in personal & spiritual development. <br />We support people to read more and evolve, whilst inspiring and supporting others.</p>
            </div>
